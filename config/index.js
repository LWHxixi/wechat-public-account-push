export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx0fc7216cbe7843b9",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "46daa8ea9f5a9333ad52ef1f42027526",
  ...
  USERS: [
    {
      ...
      id: "ozhpz6Mgyrila3GduIlyvXUQ_N84",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "G_JWuJQ_iRKXVfE9-PmkQTmJCITRWqdC1LoQrwcIJ3o",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "佛山",
